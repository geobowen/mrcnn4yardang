...
from mrcnn import visualizemodi
...
#IMAGE_DIR = r'G:\data\4-extra\ex_img_tif_alpha_removed'
...
for i in range(0,len(count)):
    ...
    if os.path.isfile(path):
        ...
        r = results[0]
        visualizemodi.display_instances(count[i],image, r['rois'], r['masks'], r['class_ids'],
...
for image_id in image_ids:
    ...
    #Show difference
    visualizemodi.display_differences(image,gt_bbox, gt_class_id, gt_mask,r['rois'],r['class_ids'],r['scores'],r['masks'],class_names)
